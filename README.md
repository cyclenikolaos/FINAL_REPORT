...
# ΜΕΘΟΔΟΣ ΚΑΙ ΤΕΧΝΙΚΕΣ ΑΝΑΠΤΥΞΗΣ
   ...
   Αρχικα το εκτελέσιμο που δημιουργούσε το github δεν έτρεχε. Μετά από την πληροφορία που έδωσε ο συμφοιτητής μου στο issue που είχε δημιουργηθεί, έκανα τις εξής ενέργειες: Άλαξα το tag "include_relative" σε "relative" σε όποια αρχεία βρισκόταν. Στη συνέχεια, μετέφερα αυτά τα αρχεία στο φάκελο _includes.
