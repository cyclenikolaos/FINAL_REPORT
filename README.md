...
# ΜΕΘΟΔΟΣ ΚΑΙ ΤΕΧΝΙΚΕΣ ΑΝΑΠΤΥΞΗΣ
   ...
   Για την εισαγωγή των πέντε φωτογραφιών, έκανα έρευνα στο wikimedia και εισήγαγα στο branch gh-pages στο gr/images, τα δύο jpg αρχεία για κάθε φωτογραφία με τη ζητούμενη ανάλυση. Στο φάκελο gr/_galllery δημιούργησα αντίστοιχα τα απαιτούμενα αρχεία md.
   Αρχικα
