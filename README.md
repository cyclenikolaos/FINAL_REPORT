...
# ΕΙΣΑΓΩΓΗ:
### Εγκατέστησα στον υπολογιστή μου το ubuntu linux version 18.04.3 πάνω στο Oracle VM virtual box 6.0. Εγκατέστησα το vi text editor, το asciinema καθώς και τη neofetch εφαρμογή. Δημιούργησα λογαριασμό στο asciinema ώστε να μπορώ να δημιουργώ τα video των εργασιών.
